    ...
    <div class="showitem clearfix">
      <?php foreach($so_hang_hoa_tren_mot_trang_result as $row){ ?>
        <div class="col-md-3 item-product bor">
          <a href="product_details.php?iddanhmuc=<?php echo $row['id_category'] ?>&idsanpham=<?php echo $row['id'] ?>">
            <img src="./public/frontend/images/<?php echo $row['image'] ?>" class="" width="100%" height="180px">
          </a>
          <div class="info-item">
            <a href="product_details.php?iddanhmuc=<?php echo $row['id_category'] ?>&idsanpham=<?php echo $row['id'] ?>"><?php echo $row['name'] ?></a>
